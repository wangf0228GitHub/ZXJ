/********************************************************************
*   A7108REG.h
*   RF Chip-A7128 Hardware Definitions
*
*   This file provides the constants associated with the
*   AMICCOM A7128 device.
*
********************************************************************/
#ifndef _A7128REG_h_
#define _A7128REG_h_
...
#define IFAT_REG 			0x36
#define CHSELECT_REG 	    0x37
#define VRB_REG 		    0x38
#define DATARATE_REG 		0x39
#define FCR_REG 		    0x3A
#define ARD_REG 		    0x3B
#define AFEP_REG 		    0x3C
#define WMUX_REG 		    0x3D
#define FCF_REG 		    0x3E
