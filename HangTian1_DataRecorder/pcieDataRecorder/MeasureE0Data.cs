...
namespace pcieDataRecorder
{
    ...
    public class MeasureE0Data
    {
        ...
        public const string A10Field = @"A10";

        public const string A11Field = @"A11";
    ...
    public class MeasureE0DataFactory
    {
        public static MeasureE0Data Construct(IDataReader reader)
        {
            ...
            try { data.A10 = Convert.ToInt32(reader["A10"]); }
            catch { }

            try { data.A11 = Convert.ToInt32(reader["A11"]); }
            catch { }
        ...
        public static MeasureE0Data Construct(DataTable dt, int rowIndex)
        {
            ...
            try { data.A10 = Convert.ToInt32(dr["A10"]); }
            catch { }

            try { data.A11 = Convert.ToInt32(dr["A11"]); }
            catch { }
    ...
    public class MeasureE0DataDBOption
    {
        public static int Insert(MeasureE0Data d)
        {
            ...
            sql.Append(", ");
            sql.Append("");
            sql.Append(d.A10.ToString());
            sql.Append("");
            sql.Append(", ");
            sql.Append("");
            sql.Append(d.A11.ToString());
            sql.Append("");
            sql.Append(", ");
            sql.Append("");
